      ...
      <View style={styles.cardInner}>
        ...
        <View style={styles.cardFoot}>
          ...
          <View style={styles.footRight}>
            ...
            <View style={[styles.activeDot, { backgroundColor: item.isActive ? colors.success : colors.disabled }]} />
          </View>
        </View>
      </View>
    </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  cardFoot: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderTopWidth: 1, borderTopColor: colors.borderLight, paddingTop: 10, marginTop: 4 },
  stockBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
